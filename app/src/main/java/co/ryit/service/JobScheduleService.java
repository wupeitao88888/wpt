...
import co.ryit.service.utils.Utils;
...
public class JobScheduleService extends JobService {
    ...
    public boolean onStartJob(JobParameters params) {
        ...
        boolean isLocalServiceWork = Utils.isServiceWork(this, "co.jmessage.Service1");
        boolean isRemoteServiceWork = Utils.isServiceWork(this, "co.jmessage.Service2");
