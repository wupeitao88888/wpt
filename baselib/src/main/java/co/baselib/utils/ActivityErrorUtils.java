...
public class ActivityErrorUtils {
    ...
    public void NoDate(boolean blean, View.OnClickListener onClickListener) {
        ...
        if (nodata_img_margin_top != -1) {
            ...
            layoutParams.setMargins(0, AppController.getInstance().dp2px(nodata_img_margin_top), 0, 0);
        ...
        if (nodata_text_margin_top != -1) {
            ...
            layoutParams.setMargins(0, AppController.getInstance().dp2px(nodata_text_margin_top), 0, 0);
    ...
    public void netError(boolean blean, View.OnClickListener onClickListener) {
        ...
        if (error_img_margin_top != -1) {
            ...
            layoutParams.setMargins(0, AppController.getInstance().dp2px(error_img_margin_top), 0, 0);
        ...
        if (error_text_margin_top != -1) {
            ...
            layoutParams.setMargins(0, AppController.getInstance().dp2px(error_text_margin_top), 0, 0);
        ...
        if (nodata_btn_margin_top != -1) {
            ...
            layoutParams.setMargins(0, AppController.getInstance().dp2px(nodata_btn_margin_top), 0, 0);
