 ...
 * 版 本 号：1.0
 */
public class ByCrashHandler implements UncaughtExceptionHandler {

    public static final String TAG = "CrashHandler";
    // 系统默认的UncaughtException处理类
    private UncaughtExceptionHandler mDefaultHandler;
    // CrashHandler实例
    private static ByCrashHandler INSTANCE = new ByCrashHandler();
    // 程序的Context对象
    ...
    public static String DISK_APP_CRASH_PATH = "/" + ByAppController.getInstance().getContext().getPackageName() + "/crash/";
    ...
    public String getSDPath() {
        ...
        String replace = ByAppController.getInstance().getContext().getPackageName();
     ...
     */
    private ByCrashHandler() {
    }

    /**
     * 获取CrashHandler实例 ,单例模式
     */
    public static ByCrashHandler getInstance() {
        return INSTANCE;
    }
...
//            restartApp();
    ...
    protected BySharedPreferencesHelper sharedPreferencesHelper = null;


    public void restartApp() {
        sharedPreferencesHelper = new BySharedPreferencesHelper(mContext,
        ...
        ByL.e("报错次数——：" + crash_count);
        if (crash < 3) {
            Intent intent = ByAppController.getInstance().getContext().getPackageManager()
                    .getLaunchIntentForPackage(ByAppController.getInstance().getContext().getPackageName());
            intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
            ByAppController.getInstance().getContext().startActivity(intent);
