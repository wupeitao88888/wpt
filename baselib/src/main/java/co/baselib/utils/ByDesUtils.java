...
public class ByDesUtils {
    ...
    public ByDesUtils() throws Exception {
        this(strDefaultKey);
    }


    public ByDesUtils(String strKey) {
...
//        String sb=new String(decrypt(hexStr2ByteArr(strIn)));
    ...
    public static ByDesUtils desUtils;

    public static ByDesUtils getInstance() {
        if (desUtils == null) {
            try {
                desUtils = new ByDesUtils();
            } catch (Exception e) {
                return desUtils;
            }
        }
    ...
    public static void main(String[] args) {
        try {
            ...
            ByDesUtils des = new ByDesUtils();// 自定义密钥
