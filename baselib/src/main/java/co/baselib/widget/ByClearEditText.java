...
public class ByClearEditText extends RelativeLayout {
    ...
    public ByClearEditText(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
    ...
    private void init(final Context context) {
        ...
        View inflate = LayoutInflater.from(context).inflate(R.layout.by_layout_clear_editview, null);
        ...
        if (ByConfig.init(context).getCoutomClear()) {
            ByImageLoaderUtils.getInstance().displayIMG(ByConfig.init(context).getClear(), clear_icon, context);
            ByImageLoaderUtils.getInstance().displayIMG(ByConfig.init(context).getBlank(), iv_password_hidden, context);
        }
        ...
        rl_password_hidden.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (isHidden) {
                    ...
                    if (ByConfig.init(context).getCoutomClear()) {
                        ByImageLoaderUtils.getInstance().displayIMG(ByConfig.init(context).getShow(), iv_password_hidden, context);
                    } else {
                        iv_password_hidden.setImageResource(R.drawable.by_show);
                    }
                } else {
                    //设置EditText文本为隐藏的
                    ...
                    if (ByConfig.init(context).getCoutomClear()) {
                        ...
                        iv_password_hidden.setImageResource(R.drawable.by_blank);
                    }
                }
                isHidden = !isHidden;
            }
...
//            lcFeedbackResidueIdea.setText(Integer.valueOf(this.temp.length()) + "/" + maxlength);
     ...
     */
    public void setOnTextChangeListener(OnByTextChangeListener onTextChangeListener) {
    ...
    public void setOnChangeListener(OnByChangeListener onChangeListener) {
