...
public class ByTitleToolBar extends ByBaseToolBar implements View.OnClickListener {
    ...
    public ByTitleToolBar(Context context) {
        super(context);
    }

    public ByTitleToolBar(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public ByTitleToolBar(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    protected void initCustomView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (!isChild(mBackTextView)) {
            ...
            layoutParams.rightMargin = typedArray.getDimensionPixelSize(
                    R.styleable.TitleToolbar_backMarginRight, ByAppController.getInstance().dp2px(DEFAULT_BACK_MARGIN_RIGHT));
