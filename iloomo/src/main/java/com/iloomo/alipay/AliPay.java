...
import com.iloomo.paysdk.BuildConfig;
...
public class AliPay {
     ...
     * 支付宝支付业务：入参app_id
     */
    public static final String APPID = BuildConfig.aliPayID;

    /**
     * 支付宝账户登录授权业务：入参pid值
     */
    public static final String PID = BuildConfig.pID;
    /**
    ...
    public static final String RSA_PRIVATE = BuildConfig.rsaPrivate;
...
//        final String orderInfo = orderParam + "&" + sign;
        ...
        Runnable payRunnable = new Runnable() {
            ...
            public void run() {
                ...
                Map<String, String> result = alipay.payV2(alipayBean.getSign(), true);
