...
import com.iloomo.banner.listener.OnBannerClickListener;
import com.iloomo.banner.listener.OnBannerListener;
import com.iloomo.banner.loader.ImageLoaderInterface;
import com.iloomo.banner.view.BannerViewPager;
import com.iloomo.paysdk.R;
import com.iloomo.utils.L;
import com.iloomo.utils.PImageLoaderUtils;
import com.iloomo.widget.MLImageViewR;
...
public class Banner extends FrameLayout implements OnPageChangeListener {
    ...
    private List<MLImageViewR> imageViews;
    ...
    private void handleTypedArray(Context context, AttributeSet attrs) {
        ...
        bannerBackgroundImage = typedArray.getResourceId(R.styleable.Banner_banner_default_image, R.drawable.gray);
        isRaius = typedArray.getBoolean(R.styleable.Banner_banner_raius_enable, false);
        typedArray.recycle();
    }
    ...
    private void setImageList(List<?> imagesUrl) {
        ...
        for (int i = 0; i <= count + 1; i++) {
            MLImageViewR imageView = null;

            L.e("是否开启圆角：" + isRaius);
            if (imageView == null) {
                if (isRaius)
                    imageView = (MLImageViewR) LayoutInflater.from(context).inflate(R.layout.banner_imageview, null);
                else
                    imageView = (MLImageViewR) LayoutInflater.from(context).inflate(R.layout.banner_imageview_re, null);
            }
     ...
     * @param isRaius
     */
    public void setEnableRaius(boolean isRaius) {
        this.isRaius = isRaius;
    }
