 ...
 * package：com.iloomo.pictureselector.lib
...
public class PictureSelectionModel {
     ...
     * @return
     */
    public PictureSelectionModel openCameraIcon(int daawable) {
        selectionConfig.openCamera = daawable;
        return this;
    }
     ...
     * @return
     */
    public PictureSelectionModel openCameraBg(int color) {
        selectionConfig.openCameraBg = color;
        return this;
    }

    /***
     * 设置打开相机模式下的title
     * @param openCameraTitle
     * @return
     */
    public PictureSelectionModel openCameraTitle(String openCameraTitle) {
        selectionConfig.openCameraTitle = openCameraTitle;
        return this;
    }
     ...
     * 设置打开录音模式下的title
     */
    public PictureSelectionModel openAudioTitle(String openAudioTitle) {
        selectionConfig.openAudioTitle = openAudioTitle;
        return this;
    }

    /***
     * 设置开开相机录像的入口的title名称是否显示
     * @param openCameraTitleVisible
     * @return
     */
    public PictureSelectionModel openCameraTitleVisible(int openCameraTitleVisible) {
        selectionConfig.openCameraTitleVisible = openCameraTitleVisible;
        return this;
    }
     ...
     * @return
     */
    public PictureSelectionModel photoTitle(String photoTitle) {
        selectionConfig.photoTitle = photoTitle;
        return this;
    }

    /***
     * 设置是否显示所有文件夹内部显示打开相机按钮  默认是不显示
     * @param isAllFoderOpenCameraVisible
     * @return
     */
    public PictureSelectionModel isAllFoderOpenCameraVisible(boolean isAllFoderOpenCameraVisible) {
        selectionConfig.isAllFoderOpenCameraVisible = isAllFoderOpenCameraVisible;
        return this;
    }

    /***
     * 设置打开什么相机 0 默认系统相机  1 拍身份证的相机
     */
    public PictureSelectionModel setOpenCameraType(int type) {
        selectionConfig.openCameraType = type;
        return this;
    }

    /***
     * 设置打开什么相机 ture 身份证正面  1 拍身份证的反面
     */
    public PictureSelectionModel setOpenType(boolean type) {
        selectionConfig.openType = type;
        return this;
    }
