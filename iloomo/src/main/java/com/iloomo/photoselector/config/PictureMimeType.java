...
public final class PictureMimeType {
    public static int ofAll() {
        return com.iloomo.photoselector.config.PictureConfig.TYPE_ALL;
    }

    public static int ofImage() {
        return com.iloomo.photoselector.config.PictureConfig.TYPE_IMAGE;
    }

    public static int ofVideo() {
        return com.iloomo.photoselector.config.PictureConfig.TYPE_VIDEO;
    }

    public static int ofAudio() {
        return com.iloomo.photoselector.config.PictureConfig.TYPE_AUDIO;
    }
