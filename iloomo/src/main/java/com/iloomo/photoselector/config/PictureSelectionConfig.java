package com.iloomo.photoselector.config;
...
import com.iloomo.photoselector.tools.PictureFileUtils;
...
public final class PictureSelectionConfig implements Parcelable {
    ...
    public int openCameraBg;
    public int openCameraTitleVisible;
    public String openCameraTitle;
    public String openAudioTitle;
    public String photoTitle;
    public boolean isAllFoderOpenCameraVisible;
    public int openCameraType;
    ...
    private void reset() {
        ...
        openCameraBg = R.color.color_E5E3E9;
        openCameraTitle = "拍摄";
        openAudioTitle = "录音";
        openCameraTitleVisible = View.VISIBLE;
        photoTitle = "所有照片";
        isAllFoderOpenCameraVisible = false;
        openCameraType = 0;//默认是系统相机 1、是身份证相机
        openType = false;
        selectionMedias = new ArrayList<>();
        DebugUtil.i("*******", "reset PictureSelectionConfig");
    }

    public static com.iloomo.photoselector.config.PictureSelectionConfig getInstance() {
        return InstanceHolder.INSTANCE;
    }

    public static com.iloomo.photoselector.config.PictureSelectionConfig getCleanInstance() {
        com.iloomo.photoselector.config.PictureSelectionConfig selectionSpec = getInstance();
        selectionSpec.reset();
        return selectionSpec;
    }

    private static final class InstanceHolder {
        private static final com.iloomo.photoselector.config.PictureSelectionConfig INSTANCE = new com.iloomo.photoselector.config.PictureSelectionConfig();
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeInt(this.openCamera);
        dest.writeInt(this.openCameraBg);
        dest.writeString(this.openCameraTitle);
        dest.writeString(this.openAudioTitle);
        dest.writeInt(this.openCameraTitleVisible);
        dest.writeString(this.photoTitle);
        dest.writeByte(this.isAllFoderOpenCameraVisible ? (byte) 1 : (byte) 0);
        dest.writeInt(this.openCameraType);
        dest.writeByte(this.openType ? (byte) 1 : (byte) 0);
    }
    ...
    protected PictureSelectionConfig(Parcel in) {
        ...
        this.openCamera = in.readInt();
        this.openCameraBg = in.readInt();
        this.openCameraTitle = in.readString();
        this.openAudioTitle = in.readString();
        this.openCameraTitleVisible = in.readInt();
        this.photoTitle = in.readString();
        this.isAllFoderOpenCameraVisible = in.readByte() != 0;
        this.openCameraType = in.readInt();
        this.openType = in.readByte() != 0;
    }

    public static final Parcelable.Creator<com.iloomo.photoselector.config.PictureSelectionConfig> CREATOR = new Parcelable.Creator<com.iloomo.photoselector.config.PictureSelectionConfig>() {
        @Override
        public com.iloomo.photoselector.config.PictureSelectionConfig createFromParcel(Parcel source) {
            return new com.iloomo.photoselector.config.PictureSelectionConfig(source);
        }

        @Override
        public com.iloomo.photoselector.config.PictureSelectionConfig[] newArray(int size) {
            return new com.iloomo.photoselector.config.PictureSelectionConfig[size];
        }
    };
}
