...
public class LocalMedia implements Parcelable {
    ...
    public static final Parcelable.Creator<com.iloomo.photoselector.entity.LocalMedia> CREATOR = new Parcelable.Creator<com.iloomo.photoselector.entity.LocalMedia>() {
        @Override
        public com.iloomo.photoselector.entity.LocalMedia createFromParcel(Parcel source) {
            return new com.iloomo.photoselector.entity.LocalMedia(source);
        }

        @Override
        public com.iloomo.photoselector.entity.LocalMedia[] newArray(int size) {
            return new com.iloomo.photoselector.entity.LocalMedia[size];
        }
    };
}
