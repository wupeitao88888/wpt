package com.iloomo.photoselector.rxbus2;
...
public class RxBus {
    ...
    private static volatile com.iloomo.photoselector.rxbus2.RxBus defaultInstance;
    ...
    public static com.iloomo.photoselector.rxbus2.RxBus getDefault() {
        com.iloomo.photoselector.rxbus2.RxBus rxBus = defaultInstance;
        if (defaultInstance == null) {
            synchronized (com.iloomo.photoselector.rxbus2.RxBus.class) {
                rxBus = defaultInstance;
                if (defaultInstance == null) {
                    rxBus = new com.iloomo.photoselector.rxbus2.RxBus();
    ...
    public void register(Object subscriber) {
        ...
        for (Method method : methods) {
            if (method.isAnnotationPresent(com.iloomo.photoselector.rxbus2.Subscribe.class)) {
                //获得参数类型
                ...
                if (parameterType != null && parameterType.length == 1) {
                    ...
                    com.iloomo.photoselector.rxbus2.Subscribe sub = method.getAnnotation(com.iloomo.photoselector.rxbus2.Subscribe.class);
                    int code = sub.code();
    ...
    private void callEvent(SubscriberMethod method, Object object) {
        ...
        if (methods != null && methods.size() > 0) {
            for (SubscriberMethod subscriberMethod : methods) {
                com.iloomo.photoselector.rxbus2.Subscribe sub = subscriberMethod.method.getAnnotation(Subscribe.class);
                int c = sub.code();
