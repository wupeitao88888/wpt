...
public final class ImageSource {
     ...
     */
    public static com.iloomo.photoselector.widget.longimage.ImageSource resource(int resId) {
        return new com.iloomo.photoselector.widget.longimage.ImageSource(resId);
    }
     ...
     */
    public static com.iloomo.photoselector.widget.longimage.ImageSource asset(String assetName) {
        if (assetName == null) {
     ...
     * @param uri image URI.
     */
    public static com.iloomo.photoselector.widget.longimage.ImageSource uri(String uri) {
        if (uri == null) {
        ...
        return new com.iloomo.photoselector.widget.longimage.ImageSource(Uri.parse(uri));
    }
     ...
     * @param uri image URI.
     */
    public static com.iloomo.photoselector.widget.longimage.ImageSource uri(Uri uri) {
        if (uri == null) {
            throw new NullPointerException("Uri must not be null");
        }
        return new com.iloomo.photoselector.widget.longimage.ImageSource(uri);
    }
     ...
     */
    public static com.iloomo.photoselector.widget.longimage.ImageSource bitmap(Bitmap bitmap) {
        if (bitmap == null) {
            throw new NullPointerException("Bitmap must not be null");
        }
        return new com.iloomo.photoselector.widget.longimage.ImageSource(bitmap, false);
    }
     ...
     * @param bitmap bitmap to be displayed.
     */
    public static com.iloomo.photoselector.widget.longimage.ImageSource cachedBitmap(Bitmap bitmap) {
        if (bitmap == null) {
            throw new NullPointerException("Bitmap must not be null");
        }
        return new com.iloomo.photoselector.widget.longimage.ImageSource(bitmap, true);
    }
     ...
     */
    public com.iloomo.photoselector.widget.longimage.ImageSource tilingEnabled() {
        return tiling(true);
    }
     ...
     * @return this instance for chaining.
     */
    public com.iloomo.photoselector.widget.longimage.ImageSource tilingDisabled() {
        return tiling(false);
    }
     ...
     * @return this instance for chaining.
     */
    public com.iloomo.photoselector.widget.longimage.ImageSource tiling(boolean tile) {
        this.tile = tile;
        return this;
    }
     ...
     * @return this instance for chaining.
     */
    public com.iloomo.photoselector.widget.longimage.ImageSource region(Rect sRegion) {
     ...
     * @return this instance for chaining.
     */
    public com.iloomo.photoselector.widget.longimage.ImageSource dimensions(int sWidth, int sHeight) {
        if (bitmap == null) {
            this.sWidth = sWidth;
