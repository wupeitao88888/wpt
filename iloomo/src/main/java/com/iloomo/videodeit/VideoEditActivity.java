...
import com.iloomo.model.OnClickEvent;
 ...
 * ================================================
 */
public class VideoEditActivity extends ActivitySupport {
    private static final String TAG = VideoEditActivity.class.getSimpleName();
    private static final long MIN_CUT_DURATION = 1 * 1000L;// 最小剪辑时间5s
    ...
    private String path;
    private long leftProgress, rightProgress = 0;
    ...
    public void initTitle() {
        ...
        setRightTitleListener(new OnClickEvent(1000) {
            @Override
            public void singleClick(View v) {
                if (!path.endsWith(".mp4")) {
                    showToastFiled("编辑功能支持mp4格式，其他格式敬请期待！");
                    return;
                }
                String startTime = (int) (leftProgress) / 1000 + "";
                String endTime;
                /**
                 * 判断结束时间
                 */
                if (rightProgress != 0) {
                    endTime = (int) ((rightProgress) / 1000 - (leftProgress) / 1000) + "";
                    L.e("持续时间：" + endTime);
                } else {
                    endTime = 30 + "";
                    L.e("持续时间：" + endTime);
                ...
                CutVideoUtils.getInstance().setOnCutListener(new OnCutListener() {
                    @Override
                    public void onSuccess(String url, int length) {
                        L.e(url);
                        IloomoConfig.init(context).showPreViewPlayView(VideoEditActivity.this, url);
                        finish();
                ...
                L.e("startTime=" + startTime + " endTime=" + endTime);
                CutVideoUtils.getInstance().cut(VideoEditActivity.this, path, startTime, endTime);
            }
        });
    }
     ...
     * @return
     */
    public String getVideoTime(int seconds) {
...
//        path = "/storage/emulated/0/电影/Funtouch OS2.5.mp4";
        ...
        mMaxWidth = AppUtil.getScreenWidth(this) - AppUtil.dip2px(this, 70);
    ...
    private void initView() {
        ...
        videoEditAdapter = new VideoEditAdapter(this,
                (AppUtil.getScreenWidth(this) - AppUtil.dip2px(this, 70)) / 10);
    ...
    private void initEditVideo() {
        ...
        mRecyclerView.addItemDecoration(new EditSpacingItemDecoration(AppUtil.dip2px(this, 35), thumbnailsCount));
        ...
        int extractW = (AppUtil.getScreenWidth(this) - AppUtil.dip2px(this, 70)) / MAX_COUNT_RANGE;
        int extractH = AppUtil.dip2px(this, 55);
...
//                videoStart();
        ...
        public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
            ...
            if (scrollX == -AppUtil.dip2px(VideoEditActivity.this, 35)) {
                scrollPos = 0;
            } else {
                ...
                isSeeking = true;
                scrollPos = (long) (averageMsPx * (AppUtil.dip2px(VideoEditActivity.this, 35) + scrollX));
    ...
    private void anim() {
        ...
        int start = (int) (AppUtil.dip2px(this, 35) + (leftProgress/*mVideoView.getCurrentPosition()*/ - scrollPos) * averagePxMs);
        int end = (int) (AppUtil.dip2px(this, 35) + (rightProgress - scrollPos) * averagePxMs);
        ...
        public void onRangeSeekBarValuesChanged(RangeSeekBar bar, long minValue, long maxValue, int action, boolean isMin, RangeSeekBar.Thumb pressedThumb) {
            ...
            switch (action) {
                ...
                case MotionEvent.ACTION_UP:
                    L.e("-----ACTION_UP--leftProgress--->>>>>>" + leftProgress + "____________" + rightProgress);
                    isSeeking = false;
                    //从minValue开始播
                    mVideoView.seekTo((int) leftProgress);
//                    videoStart();
